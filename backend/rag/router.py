...
"intent": one of
  ...
  "dispute_answer"       - the student is challenging whether a fact you already gave is CORRECT ("that's wrong", "no, the fee is 40000", "are you sure?", "that's not what the prospectus says"). Use this only when they are contesting the truth of a fact, not merely asking you to re-explain it. Set resolved_question to the fact being disputed.
